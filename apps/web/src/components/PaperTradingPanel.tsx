  ...
  return (
    <section className="panel reveal">
      <div className="sectionHeader">
        ...
        <p className="sectionMeta">Deterministic equity-only paper execution with persisted positions and order history.</p>
      </div>
      ...
      {!isLoading && !error && data ? (
        <>
          ...
          <div className="callout">
            Execution scope: {data.summary.assumptions.supported_instruments.join(", ")} only, tracked in {data.summary.assumptions.position_unit}. Fill model: {data.summary.assumptions.fill_model} Price source: {data.summary.assumptions.price_source}
          </div>
          {!data.summary.assumptions.options_execution_supported ? (
            <div className="callout">
              Options execution is not connected yet. This panel remains share-based until broker and options order plumbing are added.
            </div>
          ) : null}
        </>
      ) : null}
