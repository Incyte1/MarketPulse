  ...
  return (
    <section className="panel reveal inspector">
      ...
      <ChartContainer
        ...
        notes={[
          "Intraday candles come from the app's own market routes, not from a browser-side provider key.",
          "If candle data is unavailable, the chart surface falls back to the local placeholder provider."
        ]}
      />
