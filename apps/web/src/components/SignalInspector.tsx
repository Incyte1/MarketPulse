...
import { OptionTradeIdeaPanel } from "./OptionTradeIdeaPanel";
...
export function SignalInspector({
  ...
  return (
    <section className="panel reveal inspector">
      ...
      <OptionTradeIdeaPanel idea={signal.options_trade_idea} />
      ...
      <ChartContainer
        ...
        dataQuality={signal.market_data_quality}
        dataSource={signal.market_data_source}
        timeframe={signal.intraday_features.execution_interval}
